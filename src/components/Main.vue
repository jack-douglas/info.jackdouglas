  ...
  <div class="hello">
    ...
    <div class="links">
      <a
        class="link"
        target="_blank"
        href="https://twitter.com/jackenv"
        content="Twitter"
        v-tippy="{
          placement: 'bottom',
          arrow: true,
      ...
      <a
        class="link"
        target="_blank"
        href="https://www.crunchbase.com/person/jack-douglas-bf22"
        content="Crunchbase"
        v-tippy="{
          placement: 'bottom',
          arrow: true,
