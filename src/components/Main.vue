  ...
  <div class="hello">
    ...
    <div class="links">
      ...
      <a
        class="link"
        target="_blank"
        href="https://twitter.com/Douglas_Jack_"
        content="Twitter"
        v-tippy="{
          placement: 'bottom',
          arrow: true,
      ...
      <a
        class="link"
        target="_blank"
        href="https://twitch.tv/jackdouglas_"
        content="Twitch"
        v-tippy="{
          placement: 'bottom',
          arrow: true,
      ...
      <a
        class="link"
        target="_blank"
        href="https://keybase.io/jakdouglas"
        content="Keybase"
        v-tippy="{
          placement: 'bottom',
          arrow: true,
